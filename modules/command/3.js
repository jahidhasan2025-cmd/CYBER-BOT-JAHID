...
"https://i.postimg.cc/htCbCLW4/tumblr-n66ny2-AOCN1tck5t9o1-500.gif",
   ...
   var mention = Object.keys(event.mentions);
    ...
    if (!mention) return api.sendMessage("☹️*_*একজন কে ম্যানশন দিতে হবে-!🫂", threadID, messageID);
   var callback = () => api.sendMessage({body:`${tag}` + ` */নরম গুদে _গরম  ধোন💦🐸

বউদি কয় আহ কি চোদন 🥵🙈 `,mentions: [{tag: tag,id: Object.keys(event.mentions)[0]}],attachment: fs.createReadStream(__dirname + "/cache/buslon.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/buslon.gif"));  
