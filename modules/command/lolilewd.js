...
const fs = global.nodemodule["fs-extra"];
  var link = [
     ...
     "https://i.imgur.com/AXmBgGk.jpg"
      ...
      var callback = () => api.sendMessage({body:`কি গো তুমি এতো লুচ্চা কেন👀\nআমার সরম করে না বুজি🙈: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID);  
