...
module.exports.run = async ({ api, event, args, client, Users, Threads, __GLOBAL, Currencies }) => {
  ...
  var callback = () => api.sendMessage({ body: `[–যৌবন তোমার রসালো, টিপলে আসে দুধ.😼
!
–হেডার ভিতর নুনু দিলে শব্দ হয়, পুচুত পুচুত🤷‍♂️]`, attachment: fs.createReadStream(__dirname + "/cache/5.jpg") }, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg"));
