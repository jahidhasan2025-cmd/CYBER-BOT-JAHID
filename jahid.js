...
console.log(chalk.bold.hex("#00FF00").bold("[ JR-Jahid 9.7.5 ] » ") + chalk.bold.hex("#00FF00").bold("Initializing variables..."));
...
loginApiData.setOptions(global.config.FCAOption)
        ...
        logger(`JR-Jahid 10.10.10`, '[ JR-Jahid ]');
        logger('Hey, thank you for using this Bot', '[ Jahid ]');
        logger("Fixed by Jahid", '[ JR-Jahid ]');
        logger("FB: https://www.facebook.com/www.xnx.com9", 'Fixed by JR-Jahid');
...
console.log(chalk.bold.hex("#eff1f0").bold("================== SUCCESFULLY ==============//🍁🥀 JR-Jahid"));
